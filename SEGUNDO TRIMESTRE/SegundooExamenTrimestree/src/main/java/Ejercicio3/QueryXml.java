...
public class QueryXml {
    ...
    private static String RESOURCE = "peliculaMarvel.xml";
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            if(res == null) {
                ...
                String xquery = "/peliculas_marvel/pelicula[año >= 2016]"; // Consulta para encontrar productos con precio menor a 50
